...
const Footer = () => {
  ...
  return (
    <footer className='relative mt-auto border-t border-white/10 bg-gradient-to-b from-transparent via-primary/5 to-surface/60'>
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        <div className='flex flex-col items-center justify-center space-y-6'>
          ...
          <div className='flex flex-col items-center space-y-2'>
            ...
            <p className='text-xs md:text-sm text-text-muted/80 font-mono text-center'>
              Built with{' '}
