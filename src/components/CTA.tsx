...
const CTA = () => {
  ...
  return (
    <section id="contact" className="relative min-h-screen flex items-center justify-center py-12 sm:py-16 md:py-20 scroll-mt-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 w-full flex items-center justify-center relative z-10 py-8 sm:py-12">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.8, ease: 'easeOut' }}
          className="text-center max-w-4xl mx-auto w-full space-y-6 sm:space-y-8"
        >
          <motion.div
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold mb-3 sm:mb-4 px-4">
              Let's Work <span className="gradient-text">Together!</span>
            </h2>
            <div className="w-24 sm:w-32 h-1 bg-gradient-to-r from-primary to-accent mx-auto rounded-full mb-6 sm:mb-8" />
          </motion.div>
          ...
          <motion.p
            ...
            className="text-base sm:text-lg md:text-xl text-slate-700 dark:text-text-light leading-relaxed max-w-2xl mx-auto px-4"
          >
          ...
          >
            <Button
              ...
              variant="primary"
              className="text-base sm:text-lg px-8 sm:px-10 py-3 sm:py-4 shadow-glow-lg"
              tabIndex={0}
